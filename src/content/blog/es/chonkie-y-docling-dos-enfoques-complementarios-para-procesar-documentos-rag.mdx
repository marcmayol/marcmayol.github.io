...
- Docling convierte documentos complejos (PDF, DOCX, imágenes escaneadas) en una estructura limpia y jerarquizada.

- Chonkie optimiza el tamaño y coherencia de los fragmentos para que sean adecuados para modelos de lenguaje.

- FAISS (u otra base vectorial) permite búsquedas precisas sobre los fragmentos procesados.
...
Si quieres profundizar más sobre Docling tengo este <a href="https://marcmayol.com/blog/es/docling-la-forma-facil-de-usar-archivos-con-llms/" title="Docling: la forma fácil de trabajar con archivos y LLMs"> artículo</a> donde lo explico en detalle o también el propio artículo de <a href="https://marcmayol.com/blog/es/chonkie-el-arte-de-trocear-texto-con-inteligencia/" title="Chonkie">Chonkie</a>.
